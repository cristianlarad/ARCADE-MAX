...
export default function EscritorioPage() {
  ...
  const filterData = data?.filter((laptop) => laptop.tipo === "escritorio");
    ...
    <div className="min-h-screen p-6 bg-background">
      ...
      >
        <div className="mb-8">
          ...
          >
            Catálogo de Computadoras de Escritorio
          </motion.h1>
          <motion.p
          ...
          >
            Explora nuestra selección de computadoras de alta calidad
          </motion.p>
        </div>
