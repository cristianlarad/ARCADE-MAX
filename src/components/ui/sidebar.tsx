  ...
  return (
    ...
    >
      <Button
        ...
        size="icon"
        className={cn(
          "relative h-8 w-8 rounded-full overflow-hidden border-2 border-transparent transition-all duration-300",
          isHovered ? "border-secondary/30" : "",
          className
        )}
        onClick={(event) => {
          setIsPressed(true);
        ...
        {...props}
      >
        {/* Contenedor para las animaciones del icono */}
        <motion.div
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              style={{
                background: `radial-gradient(circle at center, ${glowColors.secondary} 0%, transparent 70%)`,
              }}
            />
          )}
        </AnimatePresence>
            ...
            <>
              {[1, 2].map((i) => (
                <motion.div
                  ...
                  style={{ borderColor: glowColors.primary }}
